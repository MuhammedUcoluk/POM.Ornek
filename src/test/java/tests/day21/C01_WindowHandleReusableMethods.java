...
public class C01_WindowHandleReusableMethods {
    ...
    @Test
    public void test01(){
        //http://the-internet.herokuapp.com/windows adresine gidelim.
        //new tab butonuna basalım
        //new taba geçip title ının "New Window" olduğunu test edelim.

        Driver.getDriver().get("http://the-internet.herokuapp.com/windows");
    ...
    @Test
    public void windowHandleReusableMethodTest() throws IOException {
        Driver.getDriver().get("http://the-internet.herokuapp.com/windows");
        Driver.getDriver().findElement(By.xpath("//a[text()='Click Here']")).click();
